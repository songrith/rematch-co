...
const TEAM_LEAGUE_MAP = {
  ...
  "Thailand":"ทีมชาติ","Japan":"ทีมชาติ","South Korea":"ทีมชาติ","Australia":"ทีมชาติ","Saudi Arabia":"ทีมชาติ","Iran":"ทีมชาติ","Iraq":"ทีมชาติ","Vietnam":"ทีมชาติ","Indonesia":"ทีมชาติ","Malaysia":"ทีมชาติ","Philippines":"ทีมชาติ","Singapore":"ทีมชาติ","China":"ทีมชาติ","India":"ทีมชาติ","UAE":"ทีมชาติ","Brazil":"ทีมชาติ","Argentina":"ทีมชาติ","France":"ทีมชาติ","England":"ทีมชาติ","Germany":"ทีมชาติ","Spain":"ทีมชาติ","Portugal":"ทีมชาติ","Italy":"ทีมชาติ","Netherlands":"ทีมชาติ","Belgium":"ทีมชาติ","Croatia":"ทีมชาติ","Poland":"ทีมชาติ","Switzerland":"ทีมชาติ","Denmark":"ทีมชาติ","Sweden":"ทีมชาติ","Norway":"ทีมชาติ","Scotland":"ทีมชาติ","USA":"ทีมชาติ","Mexico":"ทีมชาติ","Colombia":"ทีมชาติ","Uruguay":"ทีมชาติ","Chile":"ทีมชาติ","Peru":"ทีมชาติ","Ecuador":"ทีมชาติ","Canada":"ทีมชาติ","Morocco":"ทีมชาติ","Senegal":"ทีมชาติ","Nigeria":"ทีมชาติ","Ghana":"ทีมชาติ","Ivory Coast":"ทีมชาติ","Egypt":"ทีมชาติ","Cameroon":"ทีมชาติ","Algeria":"ทีมชาติ",
  "Anaheim Ducks":"NHL","Boston Bruins":"NHL","Buffalo Sabres":"NHL","Calgary Flames":"NHL","Carolina Hurricanes":"NHL","Chicago Blackhawks":"NHL","Colorado Avalanche":"NHL","Columbus Blue Jackets":"NHL","Dallas Stars":"NHL","Detroit Red Wings":"NHL","Edmonton Oilers":"NHL","Florida Panthers":"NHL","Los Angeles Kings":"NHL","Minnesota Wild":"NHL","Montreal Canadiens":"NHL","Nashville Predators":"NHL","New Jersey Devils":"NHL","New York Islanders":"NHL","New York Rangers":"NHL","Ottawa Senators":"NHL","Philadelphia Flyers":"NHL","Pittsburgh Penguins":"NHL","San Jose Sharks":"NHL","Seattle Kraken":"NHL","St. Louis Blues":"NHL","Tampa Bay Lightning":"NHL","Toronto Maple Leafs":"NHL","Utah Hockey Club":"NHL","Vancouver Canucks":"NHL","Vegas Golden Knights":"NHL","Washington Capitals":"NHL","Winnipeg Jets":"NHL",
  "Arizona Cardinals":"NFL","Atlanta Falcons":"NFL","Baltimore Ravens":"NFL","Buffalo Bills":"NFL","Carolina Panthers":"NFL","Chicago Bears":"NFL","Cincinnati Bengals":"NFL","Cleveland Browns":"NFL","Dallas Cowboys":"NFL","Denver Broncos":"NFL","Detroit Lions":"NFL","Green Bay Packers":"NFL","Houston Texans":"NFL","Indianapolis Colts":"NFL","Jacksonville Jaguars":"NFL","Kansas City Chiefs":"NFL","Las Vegas Raiders":"NFL","Los Angeles Chargers":"NFL","Los Angeles Rams":"NFL","Miami Dolphins":"NFL","Minnesota Vikings":"NFL","New England Patriots":"NFL","New Orleans Saints":"NFL","New York Giants":"NFL","New York Jets":"NFL","Philadelphia Eagles":"NFL","Pittsburgh Steelers":"NFL","San Francisco 49ers":"NFL","Seattle Seahawks":"NFL","Tampa Bay Buccaneers":"NFL","Tennessee Titans":"NFL","Washington Commanders":"NFL",
};
...
const PLATFORM_PROMPTPAY = process.env.NEXT_PUBLIC_PLATFORM_PROMPTPAY;
...
export default function ProductDetailPage() {
  ...
  async function handleOrder() {
    ...
    const fee = Math.round(product.price * 0.07 * 100) / 100;
