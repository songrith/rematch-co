      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "56px 24px 80px" }}>
        ...
        <Section title="3. วัตถุประสงค์การใช้ข้อมูล">
          ...
          <ul>
            ...
            <li>ยืนยันตัวตนผู้ขาย (KYC) เพื่อความปลอดภัยของแพลตฟอร์ม</li>
        ...
        <Section title="4. ฐานทางกฎหมายในการประมวลผลข้อมูล">
          ...
          <ul>
            ...
            <li><strong>ความยินยอม:</strong> สำหรับข้อมูลที่ท่านให้ไว้โดยสมัครใจ เช่น ข้อมูล KYC</li>
        ...
        <Section title="6. ระยะเวลาในการเก็บรักษาข้อมูล">
          <ul>
            ...
            <li>ข้อมูล KYC (บัตรประชาชน/เซลฟี่): 3 ปีนับจากวันสมัครเป็นผู้ขาย</li>
