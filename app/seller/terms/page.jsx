...
const TERMS = [
  ...
  },
  {
    ...
    desc: "ข้อมูลส่วนตัวและเอกสารยืนยันตัวตน ทั้งหมดจะถูกเก็บเป็นความลับ ใช้เพื่อการยืนยันตัวตนและตรวจสอบตัวตนเท่านั้น ไม่มีการเปิดเผยต่อบุคคลที่สาม",
  },
];
    ...
    <div style={{ minHeight: "100vh", background: "#f1f5f9", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "56px 24px 80px" }}>
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "#9ca3af", marginTop: 14 }}>
          ขั้นตอนถัดไป: ยืนยันตัวตน (บัตรประชาชน + ข้อมูลธนาคาร)
        </p>
      </div>
    </div>
  );
